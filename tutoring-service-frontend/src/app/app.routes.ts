...
import { TutoringSubjectListComponent } from './components/public-area/tutoring-subject-list/tutoring-subject-list.component';
...
import { StudentTutoringSessionListComponent } from './components/student-area/student-tutoring-session-list/student-tutoring-session-list.component';
import {
  canNavigateToAdminGuard,
  canNavigateToUserGuard,
} from './guards/can-navigate-to.guard';
import { TutorTutoringSubjectListComponent } from './components/tutor-area/tutor-tutoring-subject-list/tutor-tutoring-subject-list.component';
import { TutorTopicAreaListComponent } from './components/tutor-area/tutor-topic-area-list/tutor-topic-area-list.component';
import { TutorTutoringSessionListComponent } from './components/tutor-area/tutor-tutoring-session-list/tutor-tutoring-session-list.component';
...
export const routes: Routes = [
  {
    ...
    children: [
      { path: '', redirectTo: 'lehrveranstaltungen', pathMatch: 'full' }, // TODO warum children?
